...
export default function RecheckModal({ modalFlgfalse, data}) {
  ...
  const handle1to2 = () => {
    ...
    if(isReasonInput && reason.length < 10) {
  ...
  const handleCancelReservation = async() => {
    ...
    if (!isConfirmEnabled) {
      toast.error('동의란에 체크해 주세요.')
      return; // 조건(체크+취소사유+비번) 미충족
    }
                  ...
                  <div className="recheck-modal-step-container">
                    ...
                    <div className="recheck-modal-notice-wrapper">
                      ...
                      <div className="recheck-modal-checkbox">
                        <label>
                          <input type="checkbox" className="recheck-modal-check" checked={isAgreed} onChange={() => setIsAgreed(!isAgreed)} />
