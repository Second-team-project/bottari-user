...
export default function ReserveListLoginModal() {
  ...
  return(
    <>
      {/* 불투명 배경 */}
      <div className="reserve-list-login-modal-background"></div>
      ...
      <div className="reserve-list-login-modal-container">
        ...
        <div className="reserve-list-login-modal-text-warpper page-title-wrapper">
          <p className="reserve-list-login-modal-text reserve-list-login-modal-text-mobile">로그인 하시면<br />예약 관리가 더 쉬워져요!</p>
