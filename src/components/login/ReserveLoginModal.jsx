...
export default function ReserveLoginModal() {
  ...
  return(
    <>
      {/* 불투명 배경 */}
      <div className="reserve-login-modal-background"></div>
      ...
      <div className="reserve-login-modal-container">
        ...
        <div className="reserve-login-modal-text-warpper page-title-wrapper">
          <p className="reserve-login-modal-text reserve-login-modal-text-mobile">로그인 하시면<br />예약 관리가 더 쉬워져요!</p>
