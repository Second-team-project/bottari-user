...
export default defineConfig({
  plugins: [
    ...
    VitePWA({
      ...
      manifest: {
        name: 'bottari',            // PWA 애플리케이션의 이름 (설치 배너에 표시)
        short_name: 'bottari',      // 홈 화면 아이콘 아래에 표시될 이름
        description: 'bottari',     // 앱 설명
        ...
        icons: [
          ...
          {               // TODO: bottari icons 크기별로 추가
            src: '/icons/bottari-icon-192-v1.png', // 로컬 경로로 설정
            sizes: '192x192',              // 아이콘 크기
            type: 'image/png',
            purpose: 'any'                 // purpose 속성을 설정하지 않으면 기본 `any`
          },
          {
            src: '/icons/bottari-icon-512-v1.png',
            sizes: '512x512',
            type: 'image/png',
            purpose: 'any'               // purpose 속성을 설정하지 않으면 기본 `any`
          },
